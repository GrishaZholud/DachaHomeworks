...
class CustomBinaryTreeTest {
    CustomBinaryTree<String> customBinaryTree = new CustomBinaryTree<>();

    @Test
    public void emptyTreeOperations() {
        assertThatExceptionOfType(IndexOutOfBoundsException.class).isThrownBy(() -> {
            customBinaryTree.delete(5);
        });
        assertThatExceptionOfType(IndexOutOfBoundsException.class).isThrownBy(() -> {
            customBinaryTree.findElement(5);
        });
    }
    ...
    public void operationsOnNonExistentElement() {
        ...
        assertThatExceptionOfType(IllegalArgumentException.class).isThrownBy(()->{
            customBinaryTree.delete(20);
        });
        assertThatExceptionOfType(IllegalArgumentException.class).isThrownBy(() -> {
            customBinaryTree.findElement(20);
        });
    }
